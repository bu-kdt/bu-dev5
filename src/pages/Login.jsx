...
export default function Login({ onLogin, onBack }) {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    const u = userMap.get(loginForm.userId.trim());
    if (!u || u.password !== loginForm.pw) {
  ...
  const handleRegister = (e) => {
    ...
    if (regForm.pw !== regForm.pwConfirm) return; // 실시간 메시지가 이미 보여지고 있음
